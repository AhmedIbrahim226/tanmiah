...
class Forum(models.Model):
    ...
    subscribers = models.ManyToManyField(UserAuth, blank=True, related_name='user_forum_subscribers')
...
class Discussion(models.Model):
    ...
    subscribers = models.ManyToManyField(UserAuth, blank=True, related_name='user_discussion_subscribers')

    # admin permission
    safe = models.BooleanField(default=True, help_text=_(
    ...
    class Meta:
        permissions = [
            ('denied_to_add_safe_discussion', 'Can\'t add safe discussion.')
        ]
...
class DiscussionComment(models.Model):
    ...
    class Meta:
        permissions = [
            ('denied_to_add_safe_discussion_comment', 'Can\'t add safe discussion comment.')
        ]
...
class Answer(models.Model):
    ...
    class Meta:
        permissions = [
            ('denied_to_add_safe_answer', 'Can\'t add safe answer.')
        ]
...
class AnswerComment(models.Model):
    ...
    class Meta:
        permissions = [
            ('denied_to_add_safe_answer_comment', 'Can\'t add safe answer comment.')
        ]
